...
#define ATIM_TIMX_CPLM_CHY_GPIO_AF_A              3                                           /* AF功能选择 */
#define ATIM_TIMX_CPLM_CHY_GPIO_CLK_ENABLE_A()    do{ RCC->AHB1ENR |= 1 << 2; }while(0)       /* PC口时钟使能 */

/* A_Phase互补输出通道引脚 */
#define ATIM_TIMX_CPLM_CHYN_GPIO_PORT_A           GPIOA
#define ATIM_TIMX_CPLM_CHYN_GPIO_PIN_A            SYS_GPIO_PIN7
#define ATIM_TIMX_CPLM_CHYN_GPIO_AF_A             3                                           /* AF功能选择 */
#define ATIM_TIMX_CPLM_CHYN_GPIO_CLK_ENABLE_A()   do{ RCC->AHB1ENR |= 1 << 0; }while(0)       /* PA口时钟使能 */

/* B_Phase输出通道引脚 */
#define ATIM_TIMX_CPLM_CHY_GPIO_PORT_B            GPIOC
#define ATIM_TIMX_CPLM_CHY_GPIO_PIN_B            	SYS_GPIO_PIN7
#define ATIM_TIMX_CPLM_CHY_GPIO_AF_B              3                                           /* AF功能选择 */
#define ATIM_TIMX_CPLM_CHY_GPIO_CLK_ENABLE_B()    do{ RCC->AHB1ENR |= 1 << 2; }while(0)       /* PC口时钟使能 */
...
#define ATIM_TIMX_CPLM_CHYN_GPIO_CLK_ENABLE_B()   do{ RCC->AHB1ENR |= 1 << 1; }while(0)       /* PB口时钟使能 */

/* C_Phase输出通道引脚 */
#define ATIM_TIMX_CPLM_CHY_GPIO_PORT_C            GPIOC
#define ATIM_TIMX_CPLM_CHY_GPIO_PIN_C            	SYS_GPIO_PIN8
#define ATIM_TIMX_CPLM_CHY_GPIO_AF_C              3                                           /* AF功能选择 */
#define ATIM_TIMX_CPLM_CHY_GPIO_CLK_ENABLE_C()    do{ RCC->AHB1ENR |= 1 << 2; }while(0)       /* PC口时钟使能 */
...
#define ATIM_TIMX_CPLM_CHYN_GPIO_CLK_ENABLE_C()   do{ RCC->AHB1ENR |= 1 << 1; }while(0)       /* PB口时钟使能 */

/* 刹车输入引脚 */
#define ATIM_TIMX_CPLM_BKIN_GPIO_PORT           	GPIOA
#define ATIM_TIMX_CPLM_BKIN_GPIO_PIN            	SYS_GPIO_PIN6
#define ATIM_TIMX_CPLM_BKIN_GPIO_AF             	3                                           /* AF功能选择 */
#define ATIM_TIMX_CPLM_BKIN_GPIO_CLK_ENABLE()   	do{ RCC->AHB1ENR |= 1 << 0; }while(0)       /* PA口时钟使能 */
